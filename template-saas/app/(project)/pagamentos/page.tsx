...
export default function Pagamentos() {
    ...
    return (
        <div className="flex flex-col gap-10 items-center justify-center h-screen">
            ...
            <button className="border rounded-md px-1" onClick={() => createPaymentStripeCheckout({ testeId: "123" })}>Criar Pagamento Stripe</button>
            <button className="border rounded-md px-1" onClick={() => createSubscriptionStripeCheckout({ testeId: "123" })}>Criar Assinatura Stripe</button>
